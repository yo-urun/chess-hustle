    ...
    <div className="min-h-screen bg-[#1f1f1f] text-[#e0e0e0] flex flex-col">
      ...
      <footer className="py-8 px-6 border-t border-white/5 bg-[#1a1a1a] flex flex-col md:flex-row items-center justify-between gap-4 mt-auto">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#333]">Разработчик</span>
          <a 
            href="https://takethe.space" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="text-[10px] font-black uppercase tracking-[0.2em] text-[#666] hover:text-[#4fc3f7] transition-all flex items-center gap-1 group"
          >
            takethe.space
            <span className="w-1 h-1 rounded-full bg-[#4fc3f7] opacity-0 group-hover:opacity-100 transition-opacity" />
          </a>
        </div>
      </footer>
    </div>
